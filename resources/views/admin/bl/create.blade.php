                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-4 col-12">
                                                    <div class="mb-2">
                                                        ...
                                                        <input name="mbl_date" type="date" class="form-control" placeholder="" />
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="row">
                                                ...
                                                <div class="mb-2 mt-4">
                                                    ...
                                                    <input name="hbl_issue" type="checkbox"/><span>&nbsp;&nbsp;HBL Issue</span>
                                                </div>
                                            </div>
                                                <div class="col-md-12">
                                                    <div class="mb-2 mt-4">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-4 col-12">
                                                    <div class="mb-2">
                                                        ...
                                                        <input name="commodity" type="text" class="form-control" placeholder="" />
                                                    </div>
                                                </div>
                                                <div class="col-md-4 col-12">
                                                    <div class="mb-2">
                                                ...
                                                <div class="col-md-3 col-12">
                                                    <div class="mb-2">
                                                        ...
                                                        <input name="shipping_line_carrier" type="text" class="form-control" placeholder="" />
                                                    </div>
                                                </div>
                                                <div class="col-md-3 col-12">
                                                    <div class="mb-2">
