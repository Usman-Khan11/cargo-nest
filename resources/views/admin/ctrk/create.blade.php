                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4 col-12">
                                    <div class="mb-2">
                                        ...
                                        <input name="container_no" type="text" class="form-control container_no" placeholder="" />
                                    </div>
                                </div>
                                <div class="col-md-4 col-12">
                                    <div class="mb-2">
                                ...
                                <div class="col-md-4 col-12">
                                    <div class="mb-2">
                                        ...
                                        <input name="yom" type="text" class="form-control yom" placeholder="" />
                                    </div>
                                </div>
                                <div class="col-md-6 col-12">
                                    <div class="mb-2">
                                        <label class="form-label">Principal:</label>
                                        <input name="principal" type="text" class="form-control principal" placeholder="" />
                                    </div>
                                </div>
                                <div class="col-md-3 col-12">
                                    <div class="mb-2">
                                        <label class="form-label">Principal Code:</label>
                                        <input name="principal_code" type="text" class="form-control principal_code" placeholder="" />
                                    </div>
                                </div>
                                <div class="col-md-3 col-12">
                                    <div class="mb-2">
                                        <label class="form-label">Weight Limit:</label>
                                        <input name="weight_limit" type="text" class="form-control weight_limit" placeholder="" />
                                    </div>
                                </div>
                                ...
                                <div class="col-md-4">
                                    <div class="mb-2">
                                        ...
                                        <input name="top" type="text" class="form-control top" placeholder="" />
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="mb-2">
                                        <label class="form-label">Right:</label>
                                        <input name="right" type="text" class="form-control right" placeholder="" />
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="mb-2">
                                        <label class="form-label">Left:</label>
                                        <input name="left" type="text" class="form-control left" placeholder="" />
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="mb-2">
                                        <label class="form-label">Front:</label>
                                        <input name="front" type="text" class="form-control front" placeholder="" />
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="mb-2">
                                        <label class="form-label">Back:</label>
                                        <input name="back" type="text" class="form-control back" placeholder="" />
                                    </div>
                                </div>
                                <div class="col-md-12">
                                    <div class="mb-2">
                                        <label class="form-label">Remarks:</label>
                                        <textarea name="remarks" type="text" rows="4" class="form-control remarks" placeholder=""></textarea>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="col-md-12">
                                    <div class="mb-2 mt-2">
                                        <a class="btn btn-primary btn-sm" href="{{ asset('assets/ctrk.csv') }}" download>Download</a>
