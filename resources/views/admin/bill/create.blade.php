                            ...
                            <div class="row mb-2">
                                ...
                                <div class="col-md-3">
                                    <div class="mb-2 mt-4 d-flex">
                                        <div>
                                            <input type="radio" id="settle" name="settle" value="Settled"
                                                class="form-check-input settle">
                                            <label for="cash" class="form-check-label">Settled</label>
                                        </div>
                                        <div class="mx-2">
                                            <input type="radio" id="un-settle" name="settle" value="Un-settled"
                                                class="form-check-input settle">
                                ...
                                <div class="col-md-3">
                                    <div class="mb-2">
                                        ...
                                        <button type="button" class="btn btn-primary btn-sm mt-2">Payment
                                            Requisition</button>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-3">
                                    <div class="mb-2 mt-4 d-flex">
                                        <div>
                                            <input type="radio" id="cash" name="martial_status" value="Single"
                                                class="form-check-input martial_status">
                                            <label for="cash" class="form-check-label">Single</label>
                                        </div>
                                        <div class="mx-2">
                                            <input type="radio" id="bank" name="martial_status" value="Multiple"
                                                class="form-check-input martial_status">
                                ...
                                <div class="col-md-4">
                                    <div class="mb-2 mt-3">
                                        <label class="form-check-label mb-2">
                                            <input type="checkbox" name="auto_round_off" value="auto_round_off"
                                                class="form-check-input auto_round_off">
                                            Auto Round Off
                                        </label>
                                        <label class="form-check-label mx-3 mb-2">
                                            <input type="checkbox" name="continue_mode" value="continue_mode"
                                                class="form-check-input continue_mode">
                                            Continue Mode
                                        </label>
                                        <label class="form-check-label">
                                            <input type="checkbox" name="show_terminal" value="show_terminal"
                                                class="form-check-input show_terminal">
                                            Show Terminal
                                        </label>
                                        <label class="form-check-label mx-3">
                                            <input type="checkbox" name="rebate" value="rebate"
                                                class="form-check-input rebate">
                                            Rebate
                                        </label>
                                        <label class="form-check-label">
                                            <input type="checkbox" name="show_bl_no" value="show_bl_no"
                                                class="form-check-input show_bl_no">
                                            Show BL No
                                        </label>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-2">
                                    <div class="mb-2">
                                        ...
                                        <input name="vendor_tax_invoice_number" type="text"
                                            class="form-control vendor_tax_invoice_number">
                                    </div>
                                </div>
                                ...
                                <div class="col-md-2">
                                    <div class="mb-2">
                                        ...
                                        <input name="vendor_commercial_invoice_number" type="text"
                                            class="form-control vendor_commercial_invoice_number">
                                    </div>
                                </div>
                                ...
                                <div class="col-md-2">
                                    <div class="mb-2">
                                        ...
                                        <input name="vendor_invoice_date" type="date"
                                            class="form-control vendor_invoice_date">
                                    </div>
                                </div>
                                ...
                                <table class="datatables-basic table" style="width: 300%;">
                                    ...
                                    <tbody class="detail_repeater">
                                        ...
                                        <td><input class="form-control" name="" type="text"
                                                style="width: 100%;" /></td>
                                        <td><input class="form-control" name="b_job_no[]" type="text"
                                                style="width: 100%;" /></td>
                                        <td><input class="form-control" name="b_charges_code[]" type="text"
                                                style="width: 100%;" /></td>
                                        <td><input class="form-control" name="b_charges_name[]" type="text"
                                                style="width: 100%;" /></td>
                                        <td><input class="form-control" name="b_charges_desc[]" type="text"
                                                style="width: 100%;" /></td>
                                        <td><input class="form-control" name="b_rate_group[]" type="text"
                                                style="width: 100%;" /></td>
                                        <td><input class="form-control" name="size_type[]" type="text"
                                                style="width: 100%;" /></td>
                                        <td><input class="form-control" name="b_dg[]" type="text"
                                                style="width: 100%;" /></td>
                                        <td class="text-center"><input type="checkbox[]" name="mark[]"
                                                style="width: 16px; height:16px;" /></td>
                                        <td><input class="form-control" name="b_container[]" type="text"
                                                style="width: 100%;" /></td>
                                        <td><input class="form-control" name="b_qty[]" type="text"
                                                style="width: 100%;" /></td>
                                        <td><input class="form-control" name="b_rate[]" type="text"
                                                style="width: 100%;" /></td>
                                        <td><input class="form-control" name="b_currency[]" type="text"
                                                style="width: 100%;" /></td>
                                        <td><input class="form-control" name="b_amount[]" type="text"
                                                style="width: 100%;" /></td>
                                        <td><input class="form-control" name="b_discount[]" type="text"
                                                style="width: 100%;" /></td>
                                        <td><input class="form-control" name="b_net_amount[]" type="text"
                                                style="width: 100%;" /></td>
                                        <td><input class="form-control" name="b_margin[]" type="text"
                                                style="width: 100%;" /></td>
                                        <td><input class="form-control" name="b_tax[]" type="text"
                                                style="width: 100%;" /></td>
                                        <td><input class="form-control" name="b_tax_amt[]" type="text"
                                                style="width: 100%;" /></td>
                                        <td><input class="form-control" name="b_net_amt[]" type="text"
                                                style="width: 100%;" /></td>
                                        <td><input class="form-control" name="b_ex_rate[]" type="text"
                                                style="width: 100%;" /></td>
                                        <td><input class="form-control" name="b_local_amount[]" type="text"
                                                style="width: 100%;" /></td>
                                        <td><input class="form-control" name="b_code[]" type="text"
                                                style="width: 100%;" /></td>
                                        <td><input class="form-control" name="b_principal_name[]" type="text"
                                                style="width: 100%;" /></td>
                                        <td><input class="form-control" name="tpgl_payment[]" type="text"
                                                style="width: 100%;" /></td>
                                        <td><input class="form-control" name="tpgl_invoice[]" type="text"
                                                style="width: 100%;" /></td>
                                    </tbody>
                                </table>
                            </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-2">
                                    <div class="mb-2">
                                        ...
                                        <input name="net_amount_inv_tax" type="text"
                                            class="form-control net_amount_inv_tax">
                                    </div>
                                </div>
                                ...
                                <div class="col-md-2">
                                    <div class="mb-2">
                                        ...
                                        <input name="total_deduction" type="text"
