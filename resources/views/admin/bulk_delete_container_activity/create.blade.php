...
<div class="col-md-4">
    <div class="d-flex">
        <div class="plus" onclick="formReset('/admin/bulk_delete_container_activity/store')">
            <i class="fa fa-square-plus" title="Add"></i>
        </div>
        <div class="save">
            <i class="fa fa-save" id="submitButton" title="Save"></i>
        </div>
        <div class="xmark" onclick="deleteData('/admin/bulk_delete_container_activity/delete')">
...
@section('panel')
    <div class="container-xxl flex-grow-1 container-p-y">
        <form id="myForm" method="post" action="{{ route('admin.bulk_delete_container_activity.store') }}" enctype="multipart/form-data">
            @csrf
                            ...
                            <div class="row">
                                <div class="col-md-8">
                                    <div class="row">
                                        <div class="col-md-4">
                                            <div class="mb-2">
                                               <label for="cost" class="form-label">Container No:</label>
                                               <input id="cost" name="Container No" type="text" step="0.01" class="form-control" required>
                                            </div>
                                        </div> 
                                        <div class="col-md-4">
                                            <div class="mb-2">
                                ...
                                <div class="col-md-2" >
                                    <textarea name="" id="" style="height: 200px;margin-top: 10px;">
...
$(document).ready(function(){
    ...
    var datatable = $('.quotation_record').DataTable({
        ...
        "scrollX": true,
        "ajax": {
            "url": "{{ route('admin.bulk_delete_container_activity.create') }}",
            "type": "get",
            "data": function(d) {},
        },
        columns: [
...
function edit_row(e,data){
    ...
    if(data){
        ...
        $("#myForm").attr("action","{{ route('admin.bulk_delete_container_activity.update') }}")
...
$(".navigation").click(function(){
    ...
    let route = '/admin/bulk_delete_container_activity/get';
