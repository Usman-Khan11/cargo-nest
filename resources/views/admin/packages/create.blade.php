                    ...
                    <div class="card-body">
                        ...
                        <div class="row">
                            <div class="col-md-3 col-12">
                                <div class="mb-2">
                                    <label class="form-label">Pack Code: <span class="text-danger">*</span></label>
                                    <input name="pack_code" value="{{ old('pack_code') }}" type="text" class="form-control pack_code" placeholder="" />
                                </div>
                            </div>
                            <div class="col-md-3 col-12">
                                <div class="mb-2 mt-4">
                                    <label class="form-label"></label>
                                    <input name="default" @if(old('default') == "default") checked @endif class="default" type="checkbox" style="width:16px; height:16px;" value="default" /><span>&nbsp;&nbsp;Default</span>
                                </div>
                            </div>
                            <div class="col-md-6 col-12">
                                <div class="mb-2">
                                    <label class="form-label">Pack Name: <span class="text-danger">*</span></label>
                                    <input name="pack_name" type="text" value="{{ old('pack_name') }}" class="form-control pack_name" placeholder="" />
                                </div>
                            </div>
                            <div class="col-md-4 col-12">
                                <div class="mb-2">
                                    <label class="form-label">STD Code 2Digit:</label>
                                    <input name="std_2digit" type="text" value="{{ old('std_2digit') }}" class="form-control std_2digit" placeholder="" />
                                </div>
                            </div>
                            <div class="col-md-4 col-12">
                                <div class="mb-2">
                                    <label class="form-label">STD Code 3Digit:</label>
                                    <input name="std_3digit" type="text" value="{{ old('std_3digit') }}" class="form-control std_3digit" placeholder="" />
                                </div>
                            </div>
                            <div class="col-md-4 col-12">
                                <div class="mb-2">
                                    <label class="form-label">EPAS Code:</label>
                                    <input name="epas_code" type="text" value="{{ old('epas_code') }}" class="form-control epas_code" placeholder="" />
                                </div>
                            </div>
                        </div>
                    </div>
