...
<div class="col-md-4">
    <div class="d-flex">
        <div class="plus" onclick="formReset('/admin/cash_denomination_record/store')">
            <i class="fa fa-square-plus" title="Add"></i>
        </div>
        <div class="save">
            <i class="fa fa-save" id="submitButton" title="Save"></i>
        </div>
        <div class="xmark" onclick="deleteData('/admin/cash_denomination_record/delete')">
...
@section('panel')
    <div class="container-xxl flex-grow-1 container-p-y">
        <form id="myForm" method="post" action="{{ route('admin.cash_denomination_record.store') }}" enctype="multipart/form-data">
            @csrf
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-3">
                                            <button>
                                                <a href="" style="text-decoration: none; text-transform: none; padding: 15px; border-radius: 5px; color: black;">Pick</a>
                                            </button>
                                        </div>
                                    </div>
                                    <div class="row">
...
$(document).ready(function(){
    ...
    var datatable = $('.quotation_record').DataTable({
        ...
        "scrollX": true,
        "ajax": {
            "url": "{{ route('admin.cash_denomination_record.create') }}",
            "type": "get",
            "data": function(d) {},
        },
        columns: [
...
function edit_row(e,data){
    ...
    if(data){
        ...
        $("#myForm").attr("action","{{ route('admin.cash_denomination_record.update') }}")
...
$(".navigation").click(function(){
    ...
    let route = '/admin/cash_denomination_record/get';
