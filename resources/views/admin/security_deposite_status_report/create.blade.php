...
<div class="col-md-4">
    <div class="d-flex">
        <div class="plus" onclick="formReset('/admin/security_deposite_status_report/store')">
            <i class="fa fa-square-plus" title="Add"></i>
        </div>
        <div class="save">
            <i class="fa fa-save" id="submitButton" title="Save"></i>
        </div>
        <div class="xmark" onclick="deleteData('/admin/security_deposite_status_report/delete')">
...
@section('panel')
    <div class="container-xxl flex-grow-1 container-p-y">
        <form id="myForm" method="post" action="{{ route('admin.security_deposite_status_report.store') }}" enctype="multipart/form-data">
            @csrf
                                ...
                                <div class="col-md-4">
                                    <div class="mb-2">
                                       ...
                                       <select name="Loading List" id="cars" step="0.01" class="form-control">
                                        ...
                                        <option value="Sort">Receipt Date</option>
                                      </select>
                                    </div>
                                </div>
                                <div class="col-md-4">
...
<script>
    ...
    var datatable = $('.quotation_record').DataTable({
        ...
        "scrollX": true,
        "ajax": {
            "url": "{{ route('admin.security_deposite_status_report.create') }}",
            "type": "get",
            "data": function(d) {},
        },
        columns: [
...
function edit_row(e,data){
    ...
    if(data){
        ...
        $("#myForm").attr("action","{{ route('admin.security_deposite_status_report.update') }}")
...
$(".navigation").click(function(){
    ...
    let route = '/admin/security_deposite_status_report/get';
