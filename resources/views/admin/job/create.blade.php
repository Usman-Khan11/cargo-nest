                        ...
                        <div class="card-body">
                            ...
                            <div class="tab-content" id="myTabContent" style="background-color:#f4ffed;">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-3 col-12">
                                            <div class="mb-2 input_flex">
                                                ...
                                                <input name="job_date" type="date" value="{{ date('Y-m-d') }}" class="form-control jodate" placeholder="" />
                                            </div>
                                        </div>
                                        <div class="col-md-3 col-12">
                                            <div class="mb-2 input_flex">
                                        ...
                                        <div class="col-md-3 col-12">
                                            <div class="mb-2 input_flex">
                                                ...
                                                <select name="job_type"  class="form-select job_type" onchange="jobTypeToggle(this)">
                                    ...
                                    <div class="row mt-3">
                                        ...
                                        <div class="col-md-12 col-12">
                                            <div class="mb-3">
                                                ...
                                                <button type="button" class="btn btn-primary btn-sm mx-3 cro_btn">CRO</button>
                                                <button type="button" class="btn btn-primary btn-sm loading_program_btn">Loading Program</button>
                                ...
                                <div class="tab-pane fade" id="bl_detail" role="tabpanel" aria-labelledby="contact-tab">
                                    ...
                                    <hr/>
                                    <div class="row">
                                        <ul class="nav nav-tabs" id="myTabs" role="tablist" style="background-color:#f4ffed;">
                                            <li class="nav-item" role="presentation">
                                            ...
                                            <div class="tab-pane fade show active" id="home" role="tabpanel" aria-labelledby="home-tab">
                                                <div class="mb-4">
                                                    ...
                                                    <tbody class="receivable_charges_repeater">
                                                        <tr>
                                                            <td><i onclick="delNewReceivableChargesRepeaterRow(this)" class="fa fa-circle-xmark fa-lg text-danger"></i></td>
                                                            <td><i onclick="addNewReceivableChargesRepeaterRow(this)" class="fa fa-clone fa-lg text-info"></i></td>
                                                            ...
                                                            <td><input name="cr_bill_invoice[]" class="form-control cr_bill_invoice" type="text" style="width: 100%;"/></td>
                                                            <td>
                                                            ...
                                                            <td><input name="cr_particular[]" class="form-control cr_particular" type="text" style="width: 100%;"/></td>
                                                            <td><input name="cr_description[]" class="form-control cr_description" type="text" style="width: 100%;"/></td>
                                                            <td>
                                                            ...
                                                            <td><input name="crp_basis[]" class="form-control crp_basis" type="text" style="width: 100%;"/></td>
                                                            <td><input name="crp_pp_cc[]" class="form-control crp_pp_cc" type="text" style="width: 100%;"/></td>
                                                            <td><input name="crp_collect_by[]" class="form-control crp_collect_by" type="text" style="width: 100%;"/></td>
                                                            <td width="4%">
                                                                <select name="crp_size_type[]" class="form-select crp_size_type" style="width: 100%;">
                                                                    <option value="0" selected disabled>Select</option>
                                                                </select>
                                                            </td>
                                                            <td><input name="crp_rate_group[]" class="form-control crp_rate_group" type="text" style="width: 100%;"/></td>
                                                            <td>
                                                            ...
                                                            <td><input name="crp_shared[]" class="form-check-input crp_shared" value="shared" type="checkbox"/></td>
                                                            <td><input name="crp_code[]" class="form-control crp_code" type="text" style="width: 100%;"/></td>
                                                            <td><input name="crp_name_1[]" class="form-control crp_name_1" type="text" style="width: 100%;"/></td>
                                                            <td><input name="crp_manual[]" class="form-check-input crp_manual" value="manual" type="checkbox"/></td>
                                                            <td><input name="crp_city[]" class="form-control crp_city" type="text" style="width: 100%;"/></td>
                                                            <td><input name="crp_rate[]" class="form-control crp_rate" type="text" style="width: 100%;"/></td>
                                                            <td>
                                                                <select name="crp_currency[]" class="form-select crp_currency" style="width: 100%;">
                                                                    <option>Select</option>
                                                                </select>
                                                            </td>
                                                            <td><input name="crp_margin[]" class="form-control crp_margin" type="text" style="width: 100%;"/></td>
                                                            <td><input name="crp_amount[]" class="form-control crp_amount" type="text" style="width: 100%;"/></td>
                                                            <td><input name="crp_discount[]" class="form-control crp_discount" type="text" style="width: 100%;"/></td>
                                                            <td><input name="crp_tax_apple[]" class="form-check-input crp_tax_apple" value="tax_apply" type="checkbox"/></td>
                                                            <td><input name="crp_tax_rev[]" class="form-control crp_tax_rev" type="text" style="width: 100%;"/></td>
                                                            <td><input name="crp_tax_amount_lc[]" class="form-control crp_tax_amount_lc" type="text" style="width: 100%;"/></td>
                                                            <td><input name="crp_net_amount[]" class="form-control crp_net_amount" type="text" style="width: 100%;"/></td>
                                                            <td><input name="crp_ex_rate[]" class="form-control crp_ex_rate" type="text" style="width: 100%;"/></td>
                                                            <td><input name="crp_local_amount[]" class="form-control crp_local_amount" type="text" style="width: 100%;"/></td>
                                                            <td><input name="crp_code_2[]" class="form-control crp_code_2" type="text" style="width: 100%;"/></td>
                                                            <td><input name="crp_name_2[]" class="form-control crp_name_2" type="text" style="width: 100%;"/></td>
                                                            <td><input name="crp_manifest_remarks[]" class="form-control crp_manifest_remarks" type="text" style="width: 100%;"/></td>
                                                            <td><input name="crp_tariff_code[]" class="form-control crp_tariff_code" type="text" style="width: 100%;"/></td>
                                                            <td><input name="crp_approved[]" class="form-control crp_approved" type="text" style="width: 100%;"/></td>
                                                            <td><input name="crp_approved_by[]" class="form-control crp_approved_by" type="text" style="width: 100%;"/></td>
                                                            <td><input name="crp_approved_date[]" class="form-control crp_approved_date" type="text" style="width: 100%;"/></td>
                                                            <td><input name="crp_approved_log[]" class="form-control crp_approved_log" type="text" style="width: 100%;"/></td>
                                                        </tr>
                                                    </tbody>
                                                </table>
                                                    </div>
                                                ...
                                                <div class="mb-4">
                                                    ...
                                                    <div class="card-datatable table-responsive pt-0">
                                                        ...
                                                        <tbody class="payable_charges_repeater">
                                                            <tr>
                                                                <td><i onclick="delNewPayableChargesRepeaterRow(this)" class="fa fa-circle-xmark fa-lg text-danger"></i></td>
                                                                <td><i onclick="addNewPayableChargesRepeaterRow(this)" class="fa fa-clone fa-lg text-info"></i></td>
                                                                <td><input type="checkbox" class="form-check-input"/></td>
                                                                <td><input name="cp_s_no[]" class="form-control cp_s_no" type="text" style="width: 100%;"/></td>
                                                                <td><input name="cp_bill_invoice[]"  class="form-control cp_bill_invoice" type="text" style="width: 100%;"/></td>
                                                                <td>
                                                                    <select class="form-select cp_chrg" onchange="getChargesCurrency(this)" style="width: 100%;" name="cp_chrg[]">
                                                                        <option selected disabled value="">Select Charges</option>
                                                                    </select>
                                                                </td>
                                                                <td><input name="cp_particular[]"  class="form-control cp_particular" type="text" style="width: 100%;"/></td>
                                                                <td><input name="cp_description[]"  class="form-control cp_description" type="text" style="width: 100%;"/></td>
                                                                <td>
                                                                    <select name="cpp_type[]" class="form-select cpp_type" style="width: 100%;">
                                                                        <option></option>
                                                                        <option value="Unit">Unit</option>
                                                                        <option value="Ship">Ship</option>
                                                                    </select>
                                                                </td>
                                                                <td><input name="cpp_basis[]" class="form-control cpp_basis" type="text" style="width: 100%;"/></td>
                                                                <td><input name="cpp_pp_cc[]" class="form-control cpp_pp_cc" type="text" style="width: 100%;"/></td>
                                                                <td><input name="cpp_collect_by[]" class="form-control cpp_collect_by" type="text" style="width: 100%;"/></td>
                                                                <td width="4%">
                                                                    <select name="cpp_size_type[]" class="form-select cpp_size_type" style="width: 100%;">
                                                                        <option value="0" selected disabled>Select</option>
                                                                    </select>
                                                                </td>
                                                                <td><input name="cpp_rate_group[]" class="form-control cpp_rate_group" type="text" style="width: 100%;"/></td>
                                                                <td>
                                                                    <select name="cpp_dg_non_dg[]" class="form-select cpp_dg_non_dg" style="width: 100%;">
                                                                        <option value="Non-DG" selected>Non-DG</option>
                                                                        <option value="DG">DG</option>
                                                                        <option value="All">All</option>
                                                                    </select>
                                                                </td>
                                                                <td><input name="cpp_shared[]" class="form-check-input cpp_shared" value="shared" type="checkbox"/></td>
                                                                <td><input name="cpp_code_1[]" class="form-control cpp_code_1" type="text" style="width: 100%;"/></td>
                                                                <td><input name="cpp_name_1[]" class="form-control cpp_name_1" type="text" style="width: 100%;"/></td>
                                                                <td><input name="cpp_manual[]" class="form-check-input cpp_manual" value="manual" type="checkbox"/></td>
                                                                <td><input name="cpp_city[]" class="form-control cpp_city" type="text" style="width: 100%;"/></td>
                                                                <td><input name="cpp_rate[]" class="form-control cpp_rate" type="text" style="width: 100%;"/></td>
                                                                <td>
                                                                    <select name="cpp_currency[]" class="form-select cpp_currency" style="width: 100%;">
                                                                        <option>Select</option>
                                                                    </select>
                                                                </td>
                                                                <td><input name="cpp_margin[]" class="form-control cpp_margin" type="text" style="width: 100%;"/></td>
                                                                <td><input name="cpp_amount[]" class="form-control cpp_amount" type="text" style="width: 100%;"/></td>
                                                                <td><input name="cpp_discount[]" class="form-control cpp_discount" type="text" style="width: 100%;"/></td>
                                                                <td><input name="cpp_tax_apply[]" class="form-check-input cpp_tax_apply" value="tax_apply" type="checkbox"/></td>
                                                                <td><input name="cpp_tax_rev[]" class="form-control cpp_tax_rev" type="text" style="width: 100%;"/></td>
                                                                <td><input name="cpp_tax_amount_lc[]" class="form-control cpp_tax_amount_lc" type="text" style="width: 100%;"/></td>
                                                                <td><input name="cpp_net_amount[]" class="form-control cpp_net_amount" type="text" style="width: 100%;"/></td>
                                                                <td><input name="cpp_ex_rate[]" class="form-control cpp_ex_rate" type="text" style="width: 100%;"/></td>
                                                                <td><input name="cpp_local_amount[]" class="form-control cpp_local_amount" type="text" style="width: 100%;"/></td>
                                                                <td><input name="cpp_rotate[]" class="form-check-input cpp_rotate" value="rotate" type="checkbox"/></td>
                                                                <td><input name="cpp_code_2[]" class="form-control cpp_code_2" type="text" style="width: 100%;"/></td>
                                                                <td><input name="cpp_name_2[]" class="form-control cpp_name_2" type="text" style="width: 100%;"/></td>
                                                                <td><input name="cpp_manifest_remarks[]" class="form-control cpp_manifest_remarks" type="text" style="width: 100%;"/></td>
                                                                <td><input name="cpp_tariff_code[]" class="form-control cpp_tariff_code" type="text" style="width: 100%;"/></td>
                                                                <td><input name="cpp_approved[]" class="form-control cpp_approved" type="text" style="width: 100%;"/></td>
                                                                <td><input name="cpp_approved_by[]" class="form-control cpp_approved_by" type="text" style="width: 100%;"/></td>
                                                                <td><input name="cpp_approved_date[]" class="form-control cpp_approved_date" type="text" style="width: 100%;"/></td>
                                                                <td><input name="cpp_approved_log[]" class="form-control cpp_approved_log" type="text" style="width: 100%;"/></td>
                                                            </tr>
                                                        </tbody>
                                                    </table>
                                                    </div>
                                                ...
                                                <div class="card-datatable table-responsive pt-0">
                                                    <table class="datatables-basic table" style="width:200%;">
                                                        ...
                                                        <tbody class="summary_charges_repeater">
                                                            <tr>
                                                                <td><i onclick="delNewSummaryChargesRepeaterRow(this)" class="fa fa-circle-xmark fa-lg text-danger"></i></td>
                                                                <td><i onclick="addNewSummaryChargesRepeaterRow(this)" class="fa fa-clone fa-lg text-info"></i></td>
                                                                <td><input name="cs_s_no[]" class="form-control cs_s_no" type="text" style="width: 100%;"/></td>
                                                                <td><input name="cs_code[]" class="form-control cs_code" type="text" style="width: 100%;"/></td>
                                                                <td>
                                                                    <select class="form-select cs_charges" style="width: 100%;" name="cs_charges[]">
                                                                        <option selected disabled value="">Select Charges</option>
                                                                    </select>
                                                                </td>
                                                                <td><input name="cs_realize_revenue_1[]" class="form-control cs_realize_revenue_1" type="text" style="width: 100%;"/></td>
                                                                <td><input name="cs_unrealize_revenue_1[]" class="form-control cs_unrealize_revenue_1" type="text" style="width: 100%;"/></td>
                                                                <td><input name="cs_total_revenue[]" class="form-control cs_total_revenue" type="text" style="width: 100%;"/></td>
                                                                <td><input name="cs_realize_revenue_2[]" class="form-control cs_realize_revenue_2" type="text" style="width: 100%;"/></td>
                                                                <td><input name="cs_unrealize_revenue_2[]" class="form-control cs_unrealize_revenue_2" type="text" style="width: 100%;"/></td>
                                                                <td><input name="cs_total_cost[]" class="form-control cs_total_cost" type="text" style="width: 100%;"/></td>
                                                                <td><input name="cs_realize_net_3[]" class="form-control cs_realize_net_3" type="text" style="width: 100%;"/></td>
                                                                <td><input name="cs_unrealize_net_3[]" class="form-control cs_unrealize_net_3" type="text" style="width: 100%;"/></td>
                                                                <td><input name="cs_total_net[]" class="form-control cs_total_net" type="text" style="width: 100%;"/></td>
                                                                <td><input name="cs_detail[]" class="form-control cs_detail" type="text" style="width: 100%;"/></td>
                                                            </tr>
                                                        </tbody>
                                                    </table>
                                                </div>
                                                ...
                                                <div class="card-datatable table-responsive pt-0">
                                                    <table class="datatables-basic table" style="width:300%;">
                                                        ...
                                                        <tbody class="principal_charges_repeater">
                                                            <tr>
                                                                <td><i onclick="delNewPrincipalChargesRepeaterRow(this)" class="fa fa-circle-xmark fa-lg text-danger"></i></td>
                                                                <td><i onclick="addNewPrincipalChargesRepeaterRow(this)" class="fa fa-clone fa-lg text-info"></i></td>
                                                                <td><input name="cpc_s_no[]" class="form-control cpc_s_no" type="text" style="width: 100%;"/></td>
                                                                <td><input name="cpc_principal[]" class="form-control cpc_principal" type="text" style="width: 100%;"/></td>
                                                                <td>
                                                                    <select class="form-select cpc_chrg" style="width: 100%;" name="cpc_chrg[]">
                                                                        <option selected disabled value="">Select Charges</option>
                                                                    </select>
                                                                </td>
                                                                <td><input name="cpc_name_1[]" class="form-control cpc_name_1" type="text" style="width: 100%;"/></td>
                                                                <td><input name="cpc_description[]" class="form-control cpc_description" type="text" style="width: 100%;"/></td>
                                                                <td>
                                                                    <select name="cpc_charges_type[]" class="form-select cpc_charges_type" style="width: 100%;">
                                                                        <option></option>
                                                                        <option value="Unit">Unit</option>
                                                                        <option value="Ship">Ship</option>
                                                                    </select>
                                                                </td>
                                                                <td><input name="cpc_rec_pay_type[]" class="form-control cpc_rec_pay_type" type="text" style="width: 100%;"/></td>
                                                                <td><input name="cpc_code[]" class="form-control cpc_code" type="text" style="width: 100%;"/></td>
                                                                <td><input name="cpc_name_2[]" class="form-control cpc_name_2" type="text" style="width: 100%;"/></td>
                                                                <td width="4%">
                                                                    <select name="cpc_size_type[]" class="form-select cpc_size_type" style="width: 100%;">
                                                                        <option value="0" selected disabled>Select</option>
                                                                    </select>
                                                                </td>
                                                                <td><input name="cpc_rate_group[]" class="form-control cpc_rate_group" type="text" style="width: 100%;"/></td>
                                                                <td>
                                                                    <select name="cpc_dg_non_dg[]" class="form-select cpc_dg_non_dg" style="width: 100%;">
                                                                        <option value="Non-DG" selected>Non-DG</option>
                                                                        <option value="DG">DG</option>
                                                                        <option value="All">All</option>
                                                                    </select>
                                                                </td>
                                                                <td><input name="cpc_manual[]" class="form-control cpc_manual" type="checkbox" style="width: 16px; height: 16px;"/></td>
                                                                <td><input name="cpc_qty[]" class="form-control cpc_qty" type="text" style="width: 100%;"/></td>
                                                                <td><input name="cpc_rate[]" class="form-control cpc_rate" type="text" style="width: 100%;"/></td>
                                                                <td>
                                                                    <select name="cpc_currency[]" class="form-select cpc_currency" style="width: 100%;">
                                                                        <option>Select</option>
                                                                    </select>
                                                                </td>
                                                                <td><input name="cpc_amount[]" class="form-control cpc_amount" type="text" style="width: 100%;"/></td>
                                                                <td><input name="cpc_discount[]" class="form-control cpc_discount" type="text" style="width: 100%;"/></td>
                                                                <td><input name="cpc_net_amount[]" class="form-control cpc_net_amount" type="text" style="width: 100%;"/></td>
                                                                <td><input name="cpc_manual_ex_rate[]" class="form-control cpc_manual_ex_rate" value="manual" type="checkbox" style="width: 100%;"/></td>
                                                                <td><input name="cpc_ex_rate[]" class="form-control cpc_ex_rate" type="text" style="width: 100%;"/></td>
                                                                <td><input name="cpc_local_amount[]" class="form-control cpc_local_amount" type="text" style="width: 100%;"/></td>
                                                                <td><input name="cpc_tariff_code[]" class="form-control cpc_tariff_code" type="text" style="width: 100%;"/></td>
                                                                <td><input name="cpc_approved[]" class="form-control cpc_approved" type="text" style="width: 100%;"/></td>
                                                                <td><input name="cpc_approved_by[]" class="form-control cpc_approved_by" type="text" style="width: 100%;"/></td>
                                                                <td><input name="cpc_approved_date[]" class="form-control cpc_approved_date" type="text" style="width: 100%;"/></td>
                                                                <td><input name="cpc_approval_log[]" class="form-control cpc_approval_log" type="text" style="width: 100%;"/></td>
                                                            </tr>
                                                        </tbody>
                                                    </table>
                                                </div>
...
$(document).ready(function () {
    ...
    $(".port_of_loading, .port_of_discharge, .final_destination, .r_place_of_receipt, .r_port_of_loading, .r_port_of_discharge, .r_final_destination").select2({
        ajax: {
  ...
  $.get("/admin/job/get_quot", { quot_id: id }, function (res) {
    ...
    if (res.routing) {
      ...
      if(res.routing.port_of_loading) {
          var option = new Option(res.routing.port_of_loading.location, res.routing.port_of_loading.id, true, true);
          $(".r_port_of_loading, .port_of_loading").append(option).trigger('change');
      } else {
          $(".r_port_of_loading, .port_of_loading").val(null).trigger('change');
      }
      ...
      if(res.routing.port_of_discharge) {
          var option = new Option(res.routing.port_of_discharge.location, res.routing.port_of_discharge.id, true, true);
          $(".r_port_of_discharge, .port_of_discharge").append(option).trigger('change');
      } else {
          $(".r_port_of_discharge, .port_of_discharge").val(null).trigger('change');
      }
      ...
      if(res.routing.final_destination) {
          var option = new Option(res.routing.final_destination.location, res.routing.final_destination.id, true, true);
          $(".r_final_destination, .final_destination").append(option).trigger('change');
      } else {
          $(".r_final_destination, .final_destination").val(null).trigger('change');
      }
      ...
      if(res.routing.place_of_receipt) {
          var option = new Option(res.routing.place_of_receipt.location, res.routing.place_of_receipt.id, true, true);
      ...
      if(res.routing.terminals) {
          var option = new Option(res.routing.terminals.location_name, res.routing.terminals.id, true, true);
          $(".r_terminal").append(option).trigger('change');
      } else {
          $(".r_terminal").val(null).trigger('change');
      }
      ...
      if(res.routing.custom_clearance) {
          var option = new Option(res.routing.custom_clearance.party_name, res.routing.custom_clearance.id, true, true);
          $(".custom_clearance").append(option).trigger('change');
      } else {
          $(".custom_clearance").val(null).trigger('change');
      }
...
function getChargesCurrency(e)
{
    let val = $(e).val();
    if(val){
        $.get("/admin/job/create", { fetch_charges_currency: val }, function (res) {
          if(res){
...
function jobFormReset(route) {
    ...
    $("#myForm").find(".custom_clearance, .r_terminal, .port_of_loading, .port_of_discharge, .final_destination, .r_place_of_receipt, .r_port_of_loading, .r_port_of_discharge, .r_final_destination").val(null).trigger("change");
}
</script>
@endpush