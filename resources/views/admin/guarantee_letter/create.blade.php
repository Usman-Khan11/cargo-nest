...
<div class="col-md-4">
    <div class="d-flex">
        <div class="plus" onclick="formReset('/admin/guarantee_letter/store')">
            <i class="fa fa-square-plus" title="Add"></i>
        </div>
        <div class="save">
            <i class="fa fa-save" id="submitButton" title="Save"></i>
        </div>
        <div class="xmark" onclick="deleteData('/admin/guarantee_letter/delete')">
...
@section('panel')
    <div class="container-xxl flex-grow-1 container-p-y">
        <form id="myForm" method="post" action="{{ route('admin.guarantee_letter.store') }}" enctype="multipart/form-data">
            @csrf
                ...
                <div class="col-md-12">
                    <div class="card mb-4">
                        ...
                        <div class="card-body">
                            ...
                            <div class="row">
                                <div class="col-md-4 p-4">
                                    <label for=""><a href="">HBL # :</a></label>
                                    <input type="text" class="form-control" name="">
                                </div>
                                <div class="col-md-4 p-4">
                    
                                    <label for=""><a href="">MBL # :</a></label>
                                    <input type="date" name="date" class="form-control" id="">
                                </div>
                                <div class="col-md-4 p-4">
                                    <div class="row">
                            ...
                            <div class="row">
                                <div class="col-md-12 mb-2">
                                    ...
                                    <input type="text" class="form-control" name="" style="height: 100px;">
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-md-12">
                                    <label for="">Body :</label>
                                    <input type="text" class="form-control" name="" style="height: 300px;">
                                </div>
                            </div>
                        </div>
                    </div>
...
$(document).ready(function(){
    ...
    var datatable = $('.quotation_record').DataTable({
        ...
        "scrollX": true,
        "ajax": {
            "url": "{{ route('admin.guarantee_letter.create') }}",
            "type": "get",
            "data": function(d) {},
        },
        columns: [
...
function edit_row(e,data){
    ...
    if(data){
        ...
        $("#myForm").attr("action","{{ route('admin.guarantee_letter.update') }}")
...
$(".navigation").click(function(){
    ...
    let route = '/admin/guarantee_letter/get';
