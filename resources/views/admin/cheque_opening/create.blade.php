...
<div class="col-md-4">
    <div class="d-flex">
        <div class="plus" onclick="formReset('/admin/cheque_opening/store')">
            <i class="fa fa-square-plus" title="Add"></i>
        </div>
        <div class="save">
            <i class="fa fa-save" id="submitButton" title="Save"></i>
        </div>
        <div class="xmark" onclick="deleteData('/admin/cheque_opening/delete')">
...
@section('panel')
    <div class="container-xxl flex-grow-1 container-p-y">
        <form id="myForm" method="post" action="{{ route('admin.cheque_opening.store') }}" enctype="multipart/form-data">
            @csrf
                    ...
                    <div class="card mb-4">
                        ...
                        <div class="card-body">
                            ...
                            <div class="row">
                                <div class="col-md-3">
                                    <div class="mb-2">
                                       <label for="cost" class="form-label">Doc:</label>
                                       <input id="cost" name="Doc" type="text" step="0.01" class="form-control" required>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-3" style="margin-top: 35px;">
                                    <div class="mb-2" style="border: 1px solid rgb(54, 54, 254);">
                                        ...
                                        <label for="Vissel Wise">Receipt</label>
                                        <input type="radio" id="Shiping Line Wise" name="fav_language" value="CSS">
                                        <label for="Shiping Line Wise">Payment</label>
                                    </div>
                                </div>
                                <div class="col-md-8">
                                    <div class="mb-2">
                                ...
                                <div class="col-md-4">
                                    <div class="mb-2">
                                       <label for="cost" class="form-label">Cheque No:</label>
                                       <input id="cost" name="Cheque No" type="text" step="0.01" class="form-control" required>
                                    </div>
                                </div>
                                <div class="col-md-8">
                                    <div class="mb-2">
                                ...
                                <div class="col-md-4">
                                    <div class="mb-2">
                                       <label for="cost" class="form-label">Cheque Date:</label>
                                       <input id="cost" name="Cheque Date" type="date" step="0.01" class="form-control" required>
                                    </div>
                                </div>
                                <div class="col-md-8">
                                    <div class="mb-2">
                                       <label for="cost" class="form-label">Voucher to:</label>
                                       <input id="cost" name="Voucher to" type="text" step="0.01" class="form-control" required>
                                    </div>
                                </div>
                                <div class="col-md-2">
                                ...
                                <div class="col-md-8">
                                    <div class="mb-2">
                                       ...
                                       <select name="Loading List" id="cars" step="0.01" class="form-control">
                                        ...
                                        <option value="Sort">PAK RUPEs</option>
                                      </select>
                                    </div>
                                </div>
                                <div class="col-md-8">
                                ...
                                <div class="col-md-6">
                                    <div class="mb-2">
                                       <label for="cost" class="form-label">Drawn Bank:</label>
                                       <input id="cost" name="Drawn Bank" type="text" step="0.01" class="form-control" required>
                                    </div>
                                </div>
                                <div class="col-md-2">
                                    <div class="mb-2" style="margin-top: 35px;">
                                ...
                                <div class="col-md-2">
                                    <div class="mb-2">
                                       <label for="cost" class="form-label">Deposited Date:</label>
                                       <input id="cost" name="Deposited Date" type="date" step="0.01" class="form-control" required>
                                    </div>
                                </div>
                            </div>
                            <div class="row" style="border: 1px solid blue;">
                                <h5 style="text-align: center; background-color: rgb(206, 206, 4);">Amount Detail</h5>
                                <div class="col-md-4">
                                    <div class="mb-2">
                                       <label for="cost" class="form-label">Amount VC:</label>
                                       <input id="cost" name="Amount VC" type="number" step="0.01" class="form-control" required>
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="mb-2">
                                       <label for="cost" class="form-label">Amount LC:</label>
                                       <input id="cost" name="Amount LC" type="number" step="0.01" class="form-control" required>
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="mb-2">
...
$(document).ready(function(){
    ...
    var datatable = $('.quotation_record').DataTable({
        ...
        "scrollX": true,
        "ajax": {
            "url": "{{ route('admin.cheque_opening.create') }}",
            "type": "get",
            "data": function(d) {},
        },
        columns: [
...
function edit_row(e,data){
    ...
    if(data){
        ...
        $("#myForm").attr("action","{{ route('admin.cheque_opening.update') }}")
...
$(".navigation").click(function(){
    ...
    let route = '/admin/cheque_opening/get';
