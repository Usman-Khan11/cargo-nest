@extends('admin.layouts.app') @section('top_nav_panel')
    ...
    <div class="container-xxl flex-grow-1 container-p-y">
        <form id="myForm" method="post" action="{{ route('admin.party.store') }}" enctype="multipart/form-data">
            @csrf
            <div class="card mb-4">
                ...
                <div class="card-body">
                    <div class="d-flex justify-content-center mb-3">
                        <div class="mb-2 px-3">
                            <input name="calculation_type" type="radio" class="form-check-input" value="customer"
                                id="defaultRadio1" onclick="cusType(this)" />
                            <label class="form-check-label" for="defaultRadio1">Customer</label>
                        </div>
                        <div class="mb-2 px-3">
                            <input name="calculation_type" type="radio" class="form-check-input" value="vendor"
                                id="defaultRadio2" onclick="cusType(this)" />
                            <label class="form-check-label" for="defaultRadio2">Vendor</label>
                        </div>
                        <div class="mb-2 px-3">
                            <input name="calculation_type" type="radio" class="form-check-input" value="customer-vendor"
                                id="defaultRadio3" onclick="cusType(this)" />
                            <label class="form-check-label" for="defaultRadio3">Customer/Vendor</label>
                        </div>
                        <div class="mb-2 px-3">
                            <input name="calculation_type" type="radio" class="form-check-input" value="non-gl-parties"
                                id="defaultRadio4" onclick="cusType(this)" checked />
                        ...
                        <div class="mb-2 px-3">
                            <input name="calculation_type" type="radio" class="form-check-input"
                                value="factorating-Country" id="defaultRadio5" onclick="cusType(this)" />
                    ...
                    <ul class="nav nav-tabs" role="tablist">
                        <li class="nav-item" id="tab_1">
                            <button type="button" class="nav-link active" role="tab" data-bs-toggle="tab"
                                data-bs-target="#navs-top-basic_info" aria-controls="navs-top-basic_info"
                                aria-selected="true">
                                Basic Info
                            </button>
                        </li>
                        <li class="nav-item" id="tab_2">
                            <button type="button" class="nav-link" role="tab" data-bs-toggle="tab"
                                data-bs-target="#navs-top-other_info" aria-controls="navs-top-other_info"
                                aria-selected="false">
                                Other Info
                            </button>
                        </li>
                        <li class="nav-item" id="tab_3">
                            <button type="button" class="nav-link" role="tab" data-bs-toggle="tab"
                                data-bs-target="#navs-top-account" aria-controls="navs-top-account"
                                aria-selected="false">
                                Account Detail
                            </button>
                        </li>
                        <li class="nav-item" id="tab_4">
                            <button type="button" class="nav-link" role="tab" data-bs-toggle="tab"
                                data-bs-target="#navs-top-bank_details" aria-controls="navs-top-bank_details"
                                aria-selected="false">
                                ACH / Bank Details
                            </button>
                        </li>
                        ...
                        <li class="nav-item" id="tab_6">
                            <button type="button" class="nav-link" role="tab" data-bs-toggle="tab"
                                data-bs-target="#navs-top-insurance" aria-controls="navs-top-insurance"
                                aria-selected="false">
                                Insurance Detail
                            </button>
                        </li>
                        <li class="nav-item" id="tab_7">
                            <button type="button" class="nav-link" role="tab" data-bs-toggle="tab"
                                data-bs-target="#navs-top-company" aria-controls="navs-top-company"
                                aria-selected="false">
                                Company/CostCenter
                            </button>
                        </li>
                        <li class="nav-item" id="tab_8">
                            <button type="button" class="nav-link" role="tab" data-bs-toggle="tab"
                                data-bs-target="#navs-top-localize" aria-controls="navs-top-localize"
                                aria-selected="false">
                                Localize/KYC
                            </button>
                        </li>
                    ...
                    <div class="tab-content">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-12 col-12 mt-3">
                                    ...
                                    <div class="row type_row">
                                        ...
                                        <div class="col-md-3">
                                            <div class="mb-2">
                                                <label class="form-check-label mb-2">
                                                    <input type="checkbox" name="Type[]" value="Shipper"
                                                        class="form-check-input Type" />
                                                    Shipper
                                                </label><br />
                                                <label class="form-check-label mb-2">
                                                    <input type="checkbox" name="Type[]" value="Consignee"
                                                        class="form-check-input Type" />
                                                    Consignee
                                                </label><br />
                                                <label class="form-check-label mb-2">
                                                    <input type="checkbox" name="Type[]" value="Notify"
                                                        class="form-check-input Type" />
                                                    Notify
                                                </label><br />
                                                <label class="form-check-label mb-2">
                                                    <input type="checkbox" name="Type[]" value="Potential-Customer"
                                                        class="form-check-input Type" />
                                                    Potential Customer
                                                </label><br />
                                                <label class="form-check-label mb-2">
                                                    <input type="checkbox" name="Type[]" value="Forwarder-Coloader"
                                                        class="form-check-input Type" />
                                                    Forwarder/Coloader
                                                </label><br />
                                                <label class="form-check-label mb-2">
                                                    <input type="checkbox" name="Type[]" value="Local-Vendor"
                                                        class="form-check-input Type" />
                                                    Local Vendor
                                                </label><br />
                                                <label class="form-check-label mb-2">
                                                    <input type="checkbox" name="Type[]" value="Overseas-Agent"
                                                        class="form-check-input Type" disabled />
                                                    Overseas Agent
                                                </label><br />
                                            </div>
                                        </div>
                                        <div class="col-md-3">
                                            <div class="mb-2">
                                                <label class="form-check-label mb-2">
                                                    <input type="checkbox" name="Type[]" value="Commision-Agent"
                                                        class="form-check-input Type" />
                                                    Commision Agent
                                                </label><br />
                                                <label class="form-check-label mb-2">
                                                    <input type="checkbox" name="Type[]" value="Indentor"
                                                        class="form-check-input Type" />
                                                    Indentor
                                                </label><br />
                                                <label class="form-check-label mb-2">
                                                    <input type="checkbox" name="Type[]" value="Transporter"
                                                        class="form-check-input Type" />
                                                    Transporter
                                                </label><br />
                                                <label class="form-check-label mb-2">
                                                    <input type="checkbox" name="Type[]" value="CHA-CHB"
                                                        class="form-check-input Type" />
                                                    CHA/CHB
                                                </label><br />
                                                <label class="form-check-label mb-2">
                                                    <input type="checkbox" name="Type[]" value="Shipping-Line"
                                                        class="form-check-input Type" />
                                                    Shipping Line
                                                </label><br />
                                                <label class="form-check-label mb-2">
                                                    <input type="checkbox" name="Type[]" value="Delivery-Agent"
                                                        class="form-check-input Type" />
                                                    Delivery Agent
                                                </label><br />
                                                <label class="form-check-label mb-2">
                                        ...
                                        <div class="col-md-3">
                                            <div class="mb-2">
                                                <label class="form-check-label mb-2">
                                                    <input type="checkbox" name="Type[]" value="Buying-House"
                                                        class="form-check-input Type" />
                                                    Buying House
                                                </label><br />
                                                <label class="form-check-label mb-2">
                                                    <input type="checkbox" name="Type[]" value="Airline"
                                                        class="form-check-input Type" />
                                                    Airline
                                                </label><br />
                                                <label class="form-check-label mb-2">
                                                    <input type="checkbox" name="Type[]" value="Trucking"
                                                        class="form-check-input Type" />
                                                    Trucking
                                                </label><br />
                                                <label class="form-check-label mb-2">
                                                    <input type="checkbox" name="Type[]" value="Drayman"
                                                        class="form-check-input Type" />
                                                    Drayman
                                                </label><br />
                                                <label class="form-check-label mb-2">
                                                    <input type="checkbox" name="Type[]" value="Cartage"
                                                        class="form-check-input Type" />
                                                    Cartage
                                                </label><br />
                                                <label class="form-check-label mb-2">
                                                    <input type="checkbox" name="Type[]" value="Stevedore"
                                                        class="form-check-input Type" />
                                                    Stevedore
                                                </label><br />
                                                <label class="form-check-label mb-2">
                                                    <input type="checkbox" name="Type[]" value="Principal"
                                                        class="form-check-input Type" />
                                                    Principal
                                                </label><br />
                                            </div>
                                        ...
                                        <div class="col-md-3">
                                            <div class="mb-2">
                                                <label class="form-check-label mb-2">
                                                    <input type="checkbox" name="Type[]" value="Depot"
                                                        class="form-check-input Type" />
                                                    Depot
                                                </label><br />
                                                <label class="form-check-label mb-2">
                                                    <input type="checkbox" name="Type[]" value="Terminal"
                                                        class="form-check-input Type" />
                                                    Terminal
                                                </label><br />
                                                <label class="form-check-label mb-2">
                                                    <input type="checkbox" name="Type[]" value="Buyer"
                                                        class="form-check-input Type" />
                                                    Buyer
                                                </label><br />
                                                <label class="form-check-label mb-2">
                                                    <input type="checkbox" name="Type[]" value="Invoice-Party"
                                                        class="form-check-input Type" />
                                                    Invoice Party
                                                </label><br />
                                                <label class="form-check-label mb-2">
                                                    <input type="checkbox" name="Type[]" value="Slot-Operator"
                                                        class="form-check-input Type" />
                                                    Slot Operator
                                                </label><br />
                                                <label class="form-check-label mb-2">
                                                    <input type="checkbox" name="Type[]" value="Investor"
                                                        class="form-check-input Type" />
                                                    Investor
                                                </label><br />
                                                <label class="form-check-label mb-2">
                                                    <input type="checkbox" name="Type[]" value="Non-Operational-Party"
                                                        class="form-check-input Type" />
                                ...
                                <div class="col-md-4 col-12 mt-5">
                                    <div class="d-flex">
                                        <div class="mb-2">
                                            <label class="form-label"></label>
                                            <input name="nomination[]" type="checkbox" value="Import-Nomination"
                                                class="form-check-input" /><span>&nbsp;Import Nomination</span>
                                        </div>
                                        <div class="mb-2 px-3">
                                            <label class="form-label"></label>
                                            <input name="nomination[]" type="checkbox" value="Export-Nomination"
                                                class="form-check-input" /><span>&nbsp;Export Nomination</span>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-3 mt-4">
                                    <div class="mb-2">
                                        ...
                                        <input name="scac_iata_code" type="text" class="form-control"
                                            placeholder="" />
                                    </div>
                                </div>
                                <div class="col-md-5 mt-4">
                                    <div class="mb-2">
                                        <label class="form-label"></label>
                                        <input name="restriction" type="checkbox" value="Apply-Company-Restriction"
                                            class="form-check-input" /><span>&nbsp;Apply Company Restriction</span>
                                    </div>
                                    <div class="mb-2">
                                        <label class="form-label"></label>
                                        <input name="restriction" type="checkbox" value="Apply-CostCenter-Restriction"
                                            class="form-check-input" /><span>&nbsp;Apply Cost Center Restriction</span>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-12">
                                    <div class="sub_type_check">
                                        <div class="d-flex justify-content-between mt-4">
                                            ...
                                            <div>
                                                <input name="sub_type_input[]" type="checkbox" value="wire-transfer"
                                                    class="form-check-input" /><span>&nbsp;Wire Transfer</span>
                                            </div>
                                            <div>
                                                <input name="sub_type_input[]" type="checkbox" value="online-transfer"
                                                    class="form-check-input" /><span>&nbsp;Online Transfer</span>
                                            </div>
                                            <div>
                                                <input name="sub_type_input[]" type="checkbox" value="credit-card"
                                                    class="form-check-input" /><span>&nbsp;Credit Card</span>
                                            </div>
                                            <div>
                                                <input name="sub_type_input[]" type="checkbox" value="cheque"
                                                    class="form-check-input" /><span>&nbsp;Cheque</span>
                                            </div>
                                            <div>
                                                <input name="sub_type_input[]" type="checkbox" value="po"
                                                    class="form-check-input" /><span>&nbsp;PO</span>
                                            </div>
                                            <div>
                                                <input name="sub_type_input[]" type="checkbox" value="tt"
                                                    class="form-check-input" /><span>&nbsp;TT</span>
                                            </div>
                                            <div>
                                                <input name="sub_type_input[]" type="checkbox" value="cash"
                                                    class="form-check-input" /><span>&nbsp;Cash</span>
                                            </div>
                                            <div>
                                                <input name="sub_type_input[]" type="checkbox" value="party"
                                        ...
                                        <div class="d-flex justify-content-between mt-3">
                                            ...
                                            <div>
                                                <input name="sub_type_input[]" type="checkbox" value="personal-cheque"
                                                    class="form-check-input" /><span>&nbsp;Personal Cheque</span>
                                            </div>
                                            <div>
                                                <input name="sub_type_input[]" type="checkbox" value="digital-wallet"
                                                    class="form-check-input" /><span>&nbsp;Digital Wallet</span>
                                            </div>
                                            <div>
                                                <input name="sub_type_input[]" type="checkbox" class="form-check-input"
                                                    value="atm-transfer" /><span>&nbsp;Atm Transfer</span>
                                            </div>
                                            <div>
                                                <input name="sub_type_input[]" type="checkbox" class="form-check-input"
                                                    value="open-po" /><span>&nbsp;Open PO</span>
                                            </div>
                                            <div>
                                                <input name="sub_type_input[]" type="checkbox" value="pay-cargo"
                                                    class="form-check-input" /><span>&nbsp;Pay Cargo</span>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="p-3">
                                <table class="datatables-basic table">
                                    ...
                                    <tbody>
                                        ...
                                        <td>
                                            <input name="notification[]" type="text" value="Notification"
                                                style="width: 100%" />
                                        </td>
                                        <td>
                                            <input name="disabled[]" type="checkbox" value="disabled"
                                                style="width: 16px; height: 16px" />
                                        </td>
                                        <td>
                                            <input name="email_address[]" type="text" style="width: 100%" />
                                        </td>
                                        <td>
                            ...
                            <div class="p-3">
                                <table class="datatables-basic table">
                                    ...
                                    <tbody>
                                        ...
                                        <td><input name="" type="text" style="width: 100%" /></td>
                                        <td>
                                            <select name="insurace_company[]" style="width: 100%"></select>
                                        </td>
                                        <td>
                                            <select name="insurance_type[]" style="width: 100%"></select>
                                        </td>
                                        <td>
                                            <input name="policy_value[]" type="text" style="width: 100%" />
                                        </td>
                                        <td>
                                            <input name="policy_no[]" type="text" style="width: 100%" />
                                        </td>
                                        <td>
                                            <input name="expiry_date[]" type="text" style="width: 100%" />
                                        </td>
                                    </tbody>
                                </table>
                            </div>
                        ...
                        <div class="tab-pane fade" id="navs-top-company" role="tabpanel">
                            <div class="p-3">
                                ...
                                <input name="inactive" type="checkbox" value="Apply-Company-Restriction"
                                    style="width: 15px; height: 15px" /><span>&nbsp;Apply Company Restriction:</span>
                                <table class="datatables-basic table">
                                    <thead>
                                        <tr>
                                            <th>
                            ...
                            <div class="p-3 mt-3">
                                ...
                                <input name="inactive" type="checkbox" value="Apply-CostCenter-Restriction"
                                    style="width: 15px; height: 15px" /><span>&nbsp;Apply Cost Center Restriction:</span>
                                <table class="datatables-basic table">
                                    <thead>
                                        <tr>
                                            <th>
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            $(".custom_select").select2({
                ajax: {
                    url: "/admin/location/get_all_data",
                    dataType: 'json',
