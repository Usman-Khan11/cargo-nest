                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="mb-2 input_flex">
                                    ...
                                    <input name="username" type="text" class="form-control username" value="{{ old('username') }}" />
                                </div>
                            </div>
                            ...
                            <div class="col-md-6">
                                <div class="mb-2 input_flex">
                                    ...
                                    <input name="password" type="password" class="form-control password" value="{{ old('password') }}" />
                                </div>
                            </div>
                            ...
                            <div class="col-md-6">
                                <div class="mb-2 input_flex">
                                    ...
                                    <input name="email" type="email" class="form-control email" value="{{ old('email') }}" />
                                </div>
                            </div>
                            ...
                            <div class="col-md-6">
                                <div class="mb-2 input_flex">
                                    ...
                                    <input name="phone" type="number" class="form-control phone" value="{{ old('phone') }}" />
                                </div>
                            </div>
                            ...
                            <div class="col-md-6">
                                <div class="mb-2 input_flex">
                                    ...
                                    <input name="security_que" type="text" class="form-control security_que" value="{{ old('security_que') }}" />
                                </div>
                            </div>
                            ...
                            <div class="col-md-6">
                                <div class="mb-2 input_flex">
                                    ...
                                    <input name="security_ans" type="text" class="form-control security_ans" value="{{ old('security_ans') }}" />
                                </div>
                            </div>
                            ...
                            <div class="col-md-12">
                                <div class="mb-2 mt-1 input_flex">
                                    <label class="form-check-label mb-2">
                                        <input type="checkbox" name="status" value="1" class="form-check-input status" />
                                        Active
                                    </label>
                                    <label class="form-check-label mb-2 mx-3">
                                        <input type="checkbox" name="acount_block" value="1" class="form-check-input acount_block" />
                                        Account Block
                                    </label>
                                </div>
                            </div>
                            ...
                            <div class="col-md-6">
                                <div class="mb-2 ">
                                    <select name="max_child_acc" class="form-select max_child_acc">
                                        <option value="99">CSUL_MSAK_PAK</option>
                                    </select>
                                </div>
                            </div>
                            ...
                            <div class="col-md-6">
                                <div class="mb-2 ">
                                    <select name="max_child_acc" class="form-select max_child_acc">
                                        <option value="99">CSUL_ADMIN</option>
                                    </select>
                                </div>
                            </div>
                            ...
                            <div class="col-md-8 mt-2">
                                ...
                                <button type="button" class="btn btn-primary btn-sm"><i class="fa fa-cloud-download-alt"></i></button>
                                <button type="button" class="btn btn-primary btn-sm"><i class="fa fa-sync-alt"></i></button>
                            </div>
                        ...
                        <table class="datatables-basic table">
                            ...
                            <tbody class="detail_repeater">
                                <tr>
                                    ...
                                    <td>
                                        <input class="form-control" type="text" name="short_name[]" style="width: 100%" />
                                    </td>
                                    <td>
                                        <input class="form-control" type="text" name="company[]" style="width: 100%" />
                                    </td>
                                </tr>
                            </tbody>
                        </table>
