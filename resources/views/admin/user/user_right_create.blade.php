...
@section('panel')
    <div class="container-xxl flex-grow-1 container-p-y">
        <div class="row">
            <div class="col-md-7">
                <form id="myForm" method="post" action="{{ route('admin.user_right.store') }}"
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-12">
                                    <div class="mb-2 input_flex">
                                        ...
                                        <input name="remark" type="text" class="form-control remark"
                                            value="{{ old('remark') }}" />
                                    </div>
                                </div>
                                ...
                                <div class="col-md-12">
                                    <div class="mb-2 mt-1 input_flex">
                                        <label class="form-check-label mb-2">
                                            <input type="checkbox" name="restrict_company" value="1"
                                                class="form-check-input restrict_company" />
                                            Restric Comapny
                                        </label>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-4">
                                    ...
                                    <div class="main-image">
                                        ...
                                        <input type="file" hidden class="form-control" name="sign"
                                ...
                                <div class="col-md-4">
                                    ...
                                    <div id="imageContainer-2">
                                        <img id="uploadedImage-2"
                                            src="https://png.pngtree.com/png-vector/20220709/ourmid/pngtree-businessman-user-avatar-wearing-suit-with-red-tie-png-image_5809521.png"
                                            width="75%" class="mb-2">
                                    </div>
                                    <div class="main-image">
                                        <button type="button" class="btn btn-primary btn-sm"
                                            onclick="document.getElementById('uploadInput-2').click()">Upload</button>
                                        <input type="file" hidden class="form-control" name="sign_with_img"
                                            id="uploadInput-2" accept="image/*" />
                                        <button id="removeButton-2" type="button"
                                            class="btn btn-danger btn-sm mx-3">Remove</button>
                                    </div>
                                </div>
