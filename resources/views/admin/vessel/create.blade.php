...
@section('panel')
    <div class="container-xxl flex-grow-1 container-p-y">
        <div class="row">
            <div class="col-md-5">
                <form id="myForm" method="post" action="{{ route('admin.vessel.store') }}"
                    ...
                    <div class="card mb-4">
                        ...
                        <div class="card-body">
                            ...
                            <div class="row">
                                <div class="col-4">
                                    <div class="row g-0 align-items-center mb-1">
                                        ...
                                        <div class="col-7">
                                            <input name="vessel_code" type="text" value="{{ $code }}"
                                                class="form-control vessel_code" placeholder="" readonly />
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-8">
                                    <div class="row g-0 align-items-center mb-1">
                                        ...
                                        <div class="col-9">
                                            <input name="vessel_name" type="text" class="form-control vessel_name"
                            ...
                            <div class="row">
                                <div class="col-4">
                                    <div class="row g-0 align-items-center mb-1">
                                        ...
                                        <div class="col-7">
                                            <input name="ship_id" type="text" class="form-control ship_id"
                                                value="{{ old('ship_id') }}" />
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-4">
                                    <div class="row g-0 align-items-center mb-1">
                                        ...
                                        <div class="col-8">
                                            <input name="owner" type="text" class="form-control owner"
                                                value="{{ old('owner') }}" />
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-4">
                                    <div class="row g-0 align-items-center mb-1">
                                        ...
                                        <div class="col-6">
                                            <input name="principle_code" type="text"
                                                class="form-control principle_code" value="{{ old('principle_code') }}" />
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-4">
                                    <div class="row g-0 align-items-center mb-1">
                                        ...
                                        <div class="col-8">
                                            <input name="call_sign" type="text" class="form-control call_sign"
                                                value="{{ old('call_sign') }}" />
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-4">
                                    <div class="row g-0 align-items-center mb-1">
                                        ...
                                        <div class="col-6">
                                            <input name="imo_no" type="text" class="form-control imo_no"
                                                value="{{ old('imo_no') }}" />
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-8">
                                    <div class="row g-0 align-items-center mb-1">
                                        ...
                                        <div class="col-7">
                                            <input name="country_registered" type="text"
                                                class="form-control country_registered"
                                                value="{{ old('country_registered') }}" />
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="mb-2 mt-2">
                                        <button class="btn btn-primary btn-sm show_voyage" type="button">Show
                                            Voyage</button>
                                        <a class="btn btn-primary btn-sm" href="{{ asset('assets/vessels.csv') }}"
                                            download>Download</a>
...
@push('script')
    <script>
        ...
        var datatable = null;
        let title = 'Vessel Report';
        let filename = 'vessel-report';
