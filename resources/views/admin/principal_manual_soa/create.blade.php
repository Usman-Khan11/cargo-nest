...
<div class="col-md-4">
    <div class="d-flex">
        <div class="plus" onclick="formReset('/admin/principal_manual_soa/store')">
            <i class="fa fa-square-plus" title="Add"></i>
        </div>
        <div class="save">
            <i class="fa fa-save" id="submitButton" title="Save"></i>
        </div>
        <div class="xmark" onclick="deleteData('/admin/principal_manual_soa/delete')">
...
@section('panel')
    <div class="container-xxl flex-grow-1 container-p-y">
        <form id="myForm" method="post" action="{{ route('admin.principal_manual_soa.store') }}" enctype="multipart/form-data">
            @csrf
                            ...
                            <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            <div class="mb-2">
                                               ...
                                               <select name="Loading List" id="cars" step="0.01" class="form-control">
                                                ...
                                                <option value="Sort">Sea Export</option>
                                              </select>
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                ...
                                <div class="col-md-6">
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            <div class="mb-2">
                                                <label for="" class="form-label">Tran Type:</label>
                                               <select name="Loading List" id="cars" step="0.01" class="form-control">
                                ...
                                <table class="datatables-basic table" style="width:100%;">
                                    <thead>
                                      <tr>
                                        ...
                                        <th scope="col">Chearge Name</th>
                                        <th scope="col">Charges Description</th>
...
$(document).ready(function(){
    ...
    var datatable = $('.quotation_record').DataTable({
        ...
        "scrollX": true,
        "ajax": {
            "url": "{{ route('admin.principal_manual_soa.create') }}",
            "type": "get",
            "data": function(d) {},
        },
        columns: [
...
function edit_row(e,data){
    ...
    if(data){
        ...
        $("#myForm").attr("action","{{ route('admin.principal_manual_soa.update') }}")
...
$(".navigation").click(function(){
    ...
    let route = '/admin/principal_manual_soa/get';
