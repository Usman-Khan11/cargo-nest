...
<div class="col-md-4">
    <div class="d-flex">
        <div class="plus" onclick="formReset('/admin/equipment_invoice_process/store')">
            <i class="fa fa-square-plus" title="Add"></i>
        </div>
        <div class="save">
            <i class="fa fa-save" id="submitButton" title="Save"></i>
        </div>
        <div class="xmark" onclick="deleteData('/admin/equipment_invoice_process/delete')">
...
@section('panel')
    <div class="container-xxl flex-grow-1 container-p-y">
        <form id="myForm" method="post" action="{{ route('admin.equipment_invoice_process.store') }}" enctype="multipart/form-data">
            @csrf
                ...
                <div class="col-md-12">
                    <div class="card mb-4">
                            ...
                            <div class="card-body">
                                ...
                                <div class="sec1" style="border: 2px solid black; padding:5px;">
                                    <div class="row">
                                        <div class="col-md-6">
                                            <!-- Search form -->
                                            <div class="input-group ps-5">
                                                <div id="navbar-search-autocomplete" class="form-outline" data-mdb-input-init>
                                                    <input type="search" id="form1" placeholder="Search/Filter" class="form-control" />
                                                ...
                                                <div class="col-md-6">
                                                    <div class="row">
                                                        <div class="col-md-6">
                                                            <div class="row">
                                                                <div class="col-md-6">
                                                                    <button type="button" class="btn btn-primary btn-sm">Start Process</button>
                                                        ...
                                                        <div class="col-md-6">
                                                            ...
                                                            <input type="date" name="date" class="" id="">
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="col-md-6">
                                                    <div class="row">
                                                        <div class="col-md-6">
                                                            <div class="">
                                                                <button class="btn btn-primary btn-sm">Get Processed
                                                                    Data</button>
                                                            </div>
                                                        </div>
                                                        <div class="col-md-6">
                                ...
                                <div class="row mb-2">
                                    <div class="col-md-1">
                                        <label for="" style="display: flex; justify-content: center;padding-top: 35px;">Plugin :</label>
                                    </div>
                                    <div class="col-md-2">
                                    ...
                                    <div class="col-md-2">
                                        <label for="">Adv Dentention</label>
                                        <input type="number" class="form-control">
                                    </div>
                                    <div class="col-md-2">
                                        <label for="">Actual Dentention</label>
                                        <input type="number" class="form-control">
                                    </div>
                                    <div class="col-md-2">
                                        <label for="">Local Amount</label>
                                        <input type="number" class="form-control">
                                    </div>
                                </div>
                                <div class="row mb-2">
                                    <div class="col-md-1 ">
                                        <label for="" style="display: flex; justify-content: center;">Detention :</label>
                                    </div>
                                    <div class="col-md-2">
                                        <input type="number" class="form-control">
                                    </div>
                                ...
                                <div class="row mb-2">
                                    <div class="col-md-1">
                                        <label for="" style="display: flex; justify-content: center;">Demurrage :</label>
                                    </div>
                                    <div class="col-md-2">
                                        <input type="number" class="form-control">
                                    </div>
                                ...
                                <table class="datatables-basic table" style="width:100%;">
                                    <thead>
                                      <tr>
                                        ...
                                        <th scope="col">Calc Till Date</th>
                                        <th scope="col">Remarks</th>
                                        <th scope="col">Free</th>
                                        <th scope="col">Log</th>
                                        <th scope="col">Amount</th>
                                        <th scope="col">Adv Det Amt</th>
...
<script>
    ...
    var datatable = $('.quotation_record').DataTable({
        ...
        "scrollX": true,
        "ajax": {
            "url": "{{ route('admin.equipment_invoice_process.create') }}",
            "type": "get",
            "data": function(d) {},
        },
        columns: [
...
function edit_row(e,data){
    ...
    if(data){
        ...
        $("#myForm").attr("action","{{ route('admin.equipment_invoice_process.update') }}")
...
$(".navigation").click(function(){
    ...
    let route = '/admin/equipment_invoice_process/get';
