...
<div class="col-md-4">
    <div class="d-flex">
        <div class="plus" onclick="formReset('/admin/security_deposite_activity_report/store')">
            <i class="fa fa-square-plus" title="Add"></i>
        </div>
        <div class="save">
            <i class="fa fa-save" id="submitButton" title="Save"></i>
        </div>
        <div class="xmark" onclick="deleteData('/admin/security_deposite_activity_report/delete')">
...
@section('panel')
    <div class="container-xxl flex-grow-1 container-p-y">
        <form id="myForm" method="post" action="{{ route('admin.security_deposite_activity_report.store') }}" enctype="multipart/form-data">
            @csrf
                    ...
                    <div class="card mb-4">
                        ...
                        <div class="card-body">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    <div class="mb-2">
                                       <label for="cost" class="form-label">Receipt No:</label>
                                       <input id="cost" name="Receipt No" type="text" step="0.01" class="form-control" required>
                                    </div>
                                </div>
                               </div>
                               <div class="row">
                                ...
                                <div class="col-md-12">
                                    <div class="mb-2">
                                       <label for="cost" class="form-label">Deposit Account:</label>
                                       <input id="cost" name="Deposit Account" type="text" step="0.01" class="form-control" required>
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                        ...
                        <div class="row" style="margin-top: 20px;">
                            <div class="col-md-5">
                                <div class="row">
                                    <label class="form-label">All Activity:</label>
                                    <div class="d">
                        ...
                        <div class="c" style="border: 1px solid black">
                            <div class="mb-2">
                                <input type="radio" id="Vissel Wise" name="fav_language" value="HTML">
                                <label for="Vissel Wise">Voucher</label><br>
                                <input type="radio" id="Shiping Line Wise" name="fav_language" value="CSS">
                                <label for="Shiping Line Wise">Cheque</label><br>
                                <input type="radio" id="No Grouping" name="fav_language" value="JavaScript">
                                <label for="No Grouping">Payee Name</label><br>
                                <input type="radio" id="No Grouping" name="fav_language" value="JavaScript">
                                <label for="No Grouping">Actv Date</label><br>
                            </div>
                        </div> 
                                </div>
                            </div>
                        ...
                        <div class="row">
                            <div class="col-md-4">
                                <div class="mb-2">
                                    <label for="" class="form-label">Print Out:</label>
                                   <select name="Loading List" id="cars" step="0.01" class="form-control">
...
<script>
    ...
    var datatable = $('.quotation_record').DataTable({
        ...
        "scrollX": true,
        "ajax": {
            "url": "{{ route('admin.security_deposite_activity_report.create') }}",
            "type": "get",
            "data": function(d) {},
        },
        columns: [
...
function edit_row(e,data){
    ...
    if(data){
        ...
        $("#myForm").attr("action","{{ route('admin.security_deposite_activity_report.update') }}")
...
$(".navigation").click(function(){
    ...
    let route = '/admin/security_deposite_activity_report/get';
