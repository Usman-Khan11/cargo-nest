...
<div class="col-md-4">
    <div class="d-flex">
        <div class="plus" onclick="formReset('/admin/terminal_stock_requirement/store')">
            <i class="fa fa-square-plus" title="Add"></i>
        </div>
        <div class="save">
            <i class="fa fa-save" id="submitButton" title="Save"></i>
        </div>
        <div class="xmark" onclick="deleteData('/admin/terminal_stock_requirement/delete')">
...
@section('panel')
    <div class="container-xxl flex-grow-1 container-p-y">
        <form id="myForm" method="post" action="{{ route('admin.terminal_stock_requirement.store') }}" enctype="multipart/form-data">
            @csrf
                    ...
                    <div class="card mb-4">
                        ...
                        <div class="card-body">
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="mb-2">
                                       <label for="cost" class="form-label">Train #:</label>
                                       <input id="cost" name="Train  #" type="text" step="0.01" class="form-control" required>
                                    </div>
                                </div>
                            
                                <div class="col-md-6">
                                    <div class="mb-2">
                                       <label for="cost" class="form-label">Train Date:</label>
                                       <input id="cost" name="Train Date" type="date" step="0.01" class="form-control" required>
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                ...
                                <table class="datatables-basic table" style="width:100%;">
                                    <thead>
                                      <tr>
                                        ...
                                        <th scope="col">stock Allocated</th>
                                      </tr>
                                    </thead>
...
<script>
    ...
    var datatable = $('.quotation_record').DataTable({
        ...
        "scrollX": true,
        "ajax": {
            "url": "{{ route('admin.terminal_stock_requirement.create') }}",
            "type": "get",
            "data": function(d) {},
        },
        columns: [
...
function edit_row(e,data){
    ...
    if(data){
        ...
        $("#myForm").attr("action","{{ route('admin.terminal_stock_requirement.update') }}")
...
$(".navigation").click(function(){
    ...
    let route = '/admin/terminal_stock_requirement/get';
