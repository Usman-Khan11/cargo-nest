        ...
        <div class="card">
            <div class="card-header">
                <div class="row">
                    ...
                    <div class="col-6 text-end">
                        ...
                        <a href="{{ route('admin.account_integrate.create') }}" class="btn btn-outline-primary">View
                            Simple</a>
                    </div>
                </div>
            </div>
            <div class="card-body">
                <div class="btn-group" role="group" aria-label="Basic example">
                    ...
                    <a href="" class="btn btn-outline-secondary">Common Account</a>
                    <a href="" class="btn btn-outline-secondary">Party Parent</a>
                </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-2">
                            <div class="row g-0 align-items-center mb-1">
                                ...
                                <div class="col-8">
                                    <select name="account_type" class="account_type form-select"></select>
                                </div>
                            </div>
                        </div>
                    </div>
...
@push('script')
    <script>
        ...
        function chargesFormReset(route) {
            ...
            $("#myForm").find(".charges_id, .account_id").val(null).trigger("change");
            $("input[name=id]").val(0);
        }
    </script>
@endpush
