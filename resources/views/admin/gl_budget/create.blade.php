...
<div class="col-md-4">
    <div class="d-flex">
        <div class="plus" onclick="formReset('/admin/gl_budget/store')">
            <i class="fa fa-square-plus" title="Add"></i>
        </div>
        <div class="save">
            <i class="fa fa-save" id="submitButton" title="Save"></i>
        </div>
        <div class="xmark" onclick="deleteData('/admin/gl_budget/delete')">
...
@section('panel')
    <div class="container-xxl flex-grow-1 container-p-y">
        <form id="myForm" method="post" action="{{ route('admin.gl_budget.store') }}" enctype="multipart/form-data">
            @csrf
                    ...
                    <div class="card mb-4">
                        ...
                        <div class="card-body">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-5">
                                    <div class="mb-2">
                                       <label for="cost" class="form-label">Period:</label>
                                       <input id="cost" name="Period" type="text" step="0.01" class="form-control" required>
                                    </div>
                                </div>
                                <div class="col-md-2">
                                    <div class="mb-2">
                                ...
                                <table class="datatables-basic table" style="width:100%;">
                                    <thead>
                                      <tr>
                                        ...
                                        <th scope="col">Inforcement</th>
                                        <th scope="col">Account Code</th>
                                        <th scope="col">particular</th>
                                        <th scope="col">Cost Center</th>
                                        <th scope="col">Total (Amt)</th>
                                        <th scope="col">Quarterly (Amt)</th>
                                        <th scope="col">Monthly (Amt)</th>
                                    ...
                                    <tbody class="detail_repeater">
                                        <tr>
                                            ...
                                            <td><input name="" class="form-control" type="text" style="width: 100%;"/></td>
                                            <td><input name="" class="form-control" type="text" style="width: 100%;"/></td>
                                            <td><input name="" class="" type="checkbox"/></td>
                                        </tr>
                                    </tbody>
                                </table>
                            </div>
...
$(document).ready(function(){
    ...
    var datatable = $('.quotation_record').DataTable({
        ...
        "scrollX": true,
        "ajax": {
            "url": "{{ route('admin.gl_budget.create') }}",
            "type": "get",
            "data": function(d) {},
        },
        columns: [
...
function edit_row(e,data){
    ...
    if(data){
        ...
        $("#myForm").attr("action","{{ route('admin.gl_budget.update') }}")
