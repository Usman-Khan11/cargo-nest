...
<div class="col-md-4">
    <div class="d-flex">
        <div class="plus" onclick="formReset('/admin/refund_requisition_report/store')">
            <i class="fa fa-square-plus" title="Add"></i>
        </div>
        <div class="save">
            <i class="fa fa-save" id="submitButton" title="Save"></i>
        </div>
        <div class="xmark" onclick="deleteData('/admin/refund_requisition_report/delete')">
...
@section('panel')
    <div class="container-xxl flex-grow-1 container-p-y">
        <form id="myForm" method="post" action="{{ route('admin.refund_requisition_report.store') }}" enctype="multipart/form-data">
            @csrf
                                ...
                                <input name="id" type="hidden" value="0" />
                                    ...
                                    <div class="row"style="margin-bottom: 10px;">
                                        <div class="col-md-6" style="border: 1px solid black;">
                                            <div class="mb-2">
                                                <input type="radio" id="Vissel Wise" name="fav_language" value="HTML">
                                                <label for="Vissel Wise">All</label>
                                                <input type="radio" id="Shiping Line Wise" name="fav_language" value="CSS">
                                                <label for="Shiping Line Wise">Pending</label>
                                                <input type="radio" id="No Grouping" name="fav_language" value="JavaScript">
                                                <label for="No Grouping">Approve</label>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row"style="margin-bottom: 10px;">
                                        <div class="col-md-6" style="border: 1px solid black;">
                                            <div class="mb-2">
                                                ...
                                                <label for="Shiping Line Wise">Pending</label>
                                                <input type="radio" id="No Grouping" name="fav_language" value="JavaScript">
                                                <label for="No Grouping">Refund</label>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
...
<script>
    ...
    var datatable = $('.quotation_record').DataTable({
        ...
        "scrollX": true,
        "ajax": {
            "url": "{{ route('admin.refund_requisition_report.create') }}",
            "type": "get",
            "data": function(d) {},
        },
        columns: [
...
function edit_row(e,data){
    ...
    if(data){
        ...
        $("#myForm").attr("action","{{ route('admin.refund_requisition_report.update') }}")
...
$(".navigation").click(function(){
    ...
    let route = '/admin/refund_requisition_report/get';
