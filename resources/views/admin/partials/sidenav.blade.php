        ...
        @if (!in_array(auth()->guard('admin')->user()->id ?? 0, [21, 22]))
                    ...
                    <li class="menu-item">
                        ...
                        <ul class="menu-sub">
                            ...
                            <li class="menu-item {{ menuActive('admin.security_deposite_status_report.create') }}">
                                <a href="{{ route('admin.security_deposite_status_report.create') }}"
                                    class="menu-link">
                                    <i class="menu-icon tf-icons ti ti-user"></i>
                            ...
                            <li class="menu-item {{ menuActive('admin.security_deposite_activity_report.create') }}">
                                <a href="{{ route('admin.security_deposite_activity_report.create') }}"
                                    class="menu-link">
                                    <i class="menu-icon tf-icons ti ti-user"></i>
                    ...
                    <li class="menu-item">
                        ...
                        <ul class="menu-sub">
                            <li class="menu-item {{ menuActive('admin.guarantee_filling_anellation.create') }}">
                                <a href="{{ route('admin.guarantee_filling_anellation.create') }}"
                                    class="menu-link">
                                    <i class="menu-icon tf-icons ti ti-user"></i>
                            ...
                            <li class="menu-item {{ menuActive('admin.vessel_arrival_departure_report.create') }}">
                                <a href="{{ route('admin.vessel_arrival_departure_report.create') }}"
                                    class="menu-link">
                                    <i class="menu-icon tf-icons ti ti-user"></i>
                ...
                <ul class="menu-sub">
                    ...
                    <li class="menu-item">
                        <a href="/admin/system_policy/create" class="menu-link">
                            <i class="menu-icon tf-icons ti ti-user"></i>
                            <div data-i18n="System Policy">System Policy</div>
                        </a>
                    </li>
            ...
            <li class="menu-item">
                ...
                <ul class="menu-sub">
                    ...
                    <li class="menu-item">
                        <a href="{{ route('admin.ship_agency_license.create') }}" class="menu-link">
                            <i class="menu-icon tf-icons ti ti-user"></i>
            ...
            <li class="menu-item">
                ...
                <ul class="menu-sub">
                    ...
                    <li class="menu-item">
                        <a href="#" class="menu-link">
                            <i class="menu-icon tf-icons ti ti-money"></i>
                            <div data-i18n="SEA ACCESSORIAL CHARGE (ACCESSORIAL CHARGES)">Sea Accessorial Charge
                                (Accessorial Charges)</div>
                        </a>
                    </li>
                    <li class="menu-item">
                        <a href="#" class="menu-link">
                    ...
                    <li class="menu-item">
                        ...
                        <ul class="menu-sub">
                            ...
                            <li class="menu-item">
                                <a href="#" class="menu-link">
                                    <i class="menu-icon tf-icons ti ti-bar-chart"></i>
                                    <div data-i18n="DIRECT JOB CONTAINER WISE PROFIT AND LOSS">Direct Job Container
                                        Wise
                                        Profit and Loss</div>
                                </a>
                            </li>
                            ...
                            <li class="menu-item">
                                <a href="#" class="menu-link">
                                    ...
                                    <div data-i18n="REQUISITION FOR COURT STAMPING">Requisition for Court Stamping
                                    </div>
                                </a>
                            </li>
                            <li class="menu-item">
