...
<div class="col-md-4">
    <div class="d-flex">
        <div class="plus" onclick="formReset('/admin/detension_summary/store')">
            <i class="fa fa-square-plus" title="Add"></i>
        </div>
        <div class="save">
            <i class="fa fa-save" id="submitButton" title="Save"></i>
        </div>
        <div class="xmark" onclick="deleteData('/admin/detension_summary/delete')">
...
@section('panel')
    <div class="container-xxl flex-grow-1 container-p-y">
        <form id="myForm" method="post" action="{{ route('admin.detension_summary.store') }}" enctype="multipart/form-data">
            @csrf
                    ...
                    <div class="card mb-4">
                            ...
                            <div class="card-body">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-4">
                                        <div class="mb-2">
                                           <label for="cost" class="form-label">summary Invoice No:</label>
                                           <input id="cost" name="summary Invoice No" type="text" step="0.01" class="form-control" required>
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="mb-2">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-4">
                                        <div class="mb-2">
                                           <label for="cost" class="form-label">parent Job#:</label>
                                           <input id="cost" name="parent Job" type="text" step="0.01" class="form-control" required>
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="mb-2">
                                            <div class="btn"style="margin-top: 30px;">
                                                <button class="btn btn-primary btn-sm">Pick Invoice</button>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <table class="table">
                                        <thead>
                                          <tr>
                                            ...
                                            <th scope="col">Vesselinfo</th>
                                            <th scope="col">Invoice</th>
                                            <th scope="col">Invoice Date</th>
                                            <th scope="col">Amount FC</th>
                                            <th scope="col">ExchRate</th>
                            ...
                            <div class="col-md-4">
                                <div class="mb-2">
                                   ...
                                   <input id="cost" name="Manifest" type="number" step="0.01" class="form-control" required>
                                </div>
                                <div class="btn">
                                    <button class="btn btn-primary btn-sm">Get Field List</button>
                                </div>
                            </div>
                        </div>
                            </div>
...
<script>
    ...
    var datatable = $('.quotation_record').DataTable({
        ...
        "scrollX": true,
        "ajax": {
            "url": "{{ route('admin.detension_summary.create') }}",
            "type": "get",
            "data": function(d) {},
        },
        columns: [
...
function edit_row(e,data){
    ...
    if(data){
        ...
        $("#myForm").attr("action","{{ route('admin.detension_summary.update') }}")
...
$(".navigation").click(function(){
    ...
    let route = '/admin/detension_summary/get';
