                    ...
                    <div class="row">
                        <div class="col-md-3">
                            <div class="mb-2">
                                ...
                                <input name="trains" type="text" class="form-control">
                            </div>
                        </div>
                        ...
                        <div class="col-md-12">
                            <div class="mb-2">
                                ...
                                <textarea name="header" type="text" rows="4" class="form-control"></textarea>
                            </div>
                        </div>
                        ...
                        <div class="col-md-12">
                            <div class="mb-2">
                                ...
                                <textarea name="body" type="text" rows="6" class="form-control"></textarea>
                            </div>
                        </div>
