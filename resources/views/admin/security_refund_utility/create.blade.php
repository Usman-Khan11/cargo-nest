...
<div class="col-md-4">
    <div class="d-flex">
        <div class="plus" onclick="formReset('/admin/security_refund_utility/store')">
            <i class="fa fa-square-plus" title="Add"></i>
        </div>
        <div class="save">
            <i class="fa fa-save" id="submitButton" title="Save"></i>
        </div>
        <div class="xmark" onclick="deleteData('/admin/security_refund_utility/delete')">
...
@section('panel')
    <div class="container-xxl flex-grow-1 container-p-y">
        <form id="myForm" method="post" action="{{ route('admin.security_refund_utility.store') }}" enctype="multipart/form-data">
            @csrf
                    ...
                    <div class="card mb-4">
                            ...
                            <div class="card-body">
                                ...
                                <div class="row">
                                    <div class="col-md-6" style="border: 1px solid black;">
                                        <div class="mb-2">
                                            ...
                                            <label for="Vissel Wise">Create Refund</label>
                                            <input type="radio" id="Shiping Line Wise" name="fav_language" value="CSS">
                                            <label for="Shiping Line Wise">Update Cheque</label>
                                            <input type="radio" id="No Grouping" name="fav_language" value="JavaScript">
                                            <label for="No Grouping">security Adjustment</label>
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="mb-2">
                                           <label for="cost" class="form-label">Bank A/C:</label>
                                           <input id="cost" name="Bank A/C" type="text" step="0.01" class="form-control" required>
                                        </div>
                                    </div>
                                    <div class="col-md-2">
                                        <div class="mb-2">
                                ...
                                <div class="row">
                                    <div class="col-md-4">
                                        <div class="mb-2">
                                           <label for="cost" class="form-label">Chq Date:</label>
                                           <input id="cost" name="Chq Date" type="date" step="0.01" class="form-control" required>
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="mb-2">
                                           <label for="cost" class="form-label">Return Date:</label>
                                           <input id="cost" name="Return Date" type="date" step="0.01" class="form-control" required>
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="mb-2">
                                            <div class="btn">
                                                <button class="btn btn-primary btn-sm">Get Requisitions</button>
                                            </div>
                                            <div class="btn">
                                                <button class="btn btn-primary btn-sm">Return</button>
                                            </div>
                                            <label for="cost" class="form-label">System Date Input Format:dd-mm-yyyy</label>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <table class="datatables-basic table" style="width:100%;">
                                    <thead>
                                      <tr>
                                        ...
                                        <th scope="col">Total Req Amount</th>
                                        <th scope="col">Narration</th>
                                        <th scope="col">Req Date</th>
                                        <th scope="col">Custumer</th>
                                        <th scope="col">Req Approve</th>
                                        <th scope="col">Cntr Return Date</th>
                                        <th scope="col">Remaining Bal</th>
                                      </tr>
                                    </thead>
...
<script>
    ...
    var datatable = $('.quotation_record').DataTable({
        ...
        "scrollX": true,
        "ajax": {
            "url": "{{ route('admin.security_refund_utility.create') }}",
            "type": "get",
            "data": function(d) {},
        },
        columns: [
...
function edit_row(e,data){
    ...
    if(data){
        ...
        $("#myForm").attr("action","{{ route('admin.security_refund_utility.update') }}")
...
$(".navigation").click(function(){
    ...
    let route = '/admin/security_refund_utility/get';
