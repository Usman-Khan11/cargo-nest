...
Route::namespace('Admin')
    ...
    ->group(function () {
        ...
        Route::middleware(['admin'])->group(function () {
            ...
            Route::get('manifest/allocation', [ManifestController::class, 'get_manifest_allocate'])->name('manifest.allocation');
            ...
            Route::get('chart_account/get_all_data', [ChartAccountController::class, 'getAllData'])->name('chart_account.get_all_data');
